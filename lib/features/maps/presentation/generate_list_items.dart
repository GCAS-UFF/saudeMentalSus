...
import 'package:saudeMentalSus/features/maps/presentation/call_and_message_service.dart';
...
class GenerateListItems {
  ...
  static ListTile generateOpeningHours(List<Reception> list) => ListTile(
      ...
      title: Text("Horário de atendimento: ",  style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold)),
     subtitle: Column(
